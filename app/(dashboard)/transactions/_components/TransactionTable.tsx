 ...
 const columns: ColumnDef<TransactionHistoryRow>[] = [
  ...
  },
  {
    ...
    cell: ({ row }) => (
      <div
        className={cn(
          " rounded-lg text-center p-2 capitalize",
...
function TransactionTable({ from, to }: Props) {
  ...
  const table = useReactTable({
    ...
    // initialState: {
    //     pagination: {
    //         pageSize: 2, //max number of rows that would be shown at once
    //     },
    // },
      ...
      <div className="flex flex-wrap items-end justify-between gap-2 py-4">
       <div className=" flex gap-2">
        {table.getColumn('category') && (
            <DataTableFacetedFilter title="Category" column={table.getColumn('category')} options={categoriesOption} />
        )}
